//
//  SatildiProfilDetayController.swift
//  SatGitsin
//
...
import UIKit
import Firebase
class SatildiProfilDetayController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    var id: String = ""
    var IlanListe = [Ilan]()
    @IBOutlet weak var pdSatiliyor: UITableView!
